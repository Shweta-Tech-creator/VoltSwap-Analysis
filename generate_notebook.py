    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "stations_count = 5\n",
                "\n",
                "# Using the new improved scenario revenue:\n",
                "total_projected_revenue = new_total_revenue * stations_count * months\n",
                "net_benefit = total_projected_revenue - investment\n",
                "\n",
                "print(f\"Total Investment: ₹{investment:,.2f}\")\n",
                "print(f\"Total Projected Revenue (3 Years): ₹{total_projected_revenue:,.2f}\")\n",
                "print(f\"Net Benefit (Revenue - Investment): ₹{net_benefit:,.2f}\")\n",
                "\n",
                "if net_benefit > 0:\n",
